...
class Enemy:
    ...
    def set_target(self):
        if self.personality == "speedy" or self.personality == "slow":
            ...
            if self.app.player.grid_pos[0] > Utils.COLS//2 and self.app.player.grid_pos[1] > Utils.ROWS//2:
                return vec(1, 1)
            if self.app.player.grid_pos[0] > Utils.COLS//2 and self.app.player.grid_pos[1] < Utils.ROWS//2:
                return vec(1, Utils.ROWS-2)
            if self.app.player.grid_pos[0] < Utils.COLS//2 and self.app.player.grid_pos[1] > Utils.ROWS//2:
                return vec(Utils.COLS-2, 1)
            else:
                return vec(Utils.COLS-2, Utils.ROWS-2)
